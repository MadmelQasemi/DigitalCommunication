...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure 5 Plotten alle bisherigen Diagramme auf der Empfängerseite nun mit den verrauschten Signalen. (Figure 3+4)
% filtered 
...
fig5 = figure('Name', 'Figure 5: Matched Filter with noise', 'NumberTitle', 'off');  
subplot(2,1,1);
